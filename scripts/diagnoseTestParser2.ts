...
console.log("Validation isValid:", parsed.validation.isValid);
console.log("Validation errors:", parsed.validation.errors);
console.log("Validation warnings:", parsed.validation.warnings);
console.log("Section count:", parsed.sections.length);
console.log("Sections:", parsed.sections.map(s => ({
  letter: s.sectionLetter,
  title: s.title,
  type: s.sectionType,
  qCount: s.questions.length,
  totalMarks: s.totalMarks,
  declaredMarks: s.declaredMarks
})));
console.log("Total questions:", parsed.questions.length);
console.log("Total calculated marks:", parsed.validation.totalCalculatedMarks);
